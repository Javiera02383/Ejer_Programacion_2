package Tareas_unidad_1.Capitulo_7.ej_7_21;
...
public class Juego {
    ...
    public static void mostrarPiso9() {
    ...
    public static void desplazar() {
        ...
        if (direccion % 2 == 0) {// < es par (incluyendo negativos), es decir, se mueve de manera horizontal
            if (direccion == 0 || direccion % 4 == 0) {// si la direccion es 0 o multiplo de 4 se esta moviendo de
                                                       // izquierda-derecha
    ...
    // Muestra el arreglo bidimensional que es el piso por donde se desplaza la
    // tortuga
    ...
    // Realiza el movimiento de la tortuga de manera horizontal de izquierda a
    // derecha @param avanzar Cantidad de lugares que avanzara la tortuga

    public static void escribirMult4(int avanzar) {
        if ((avanzar + columnaActual) < piso[filaActual].length) {// < validar si puede avanzar (si no se sale del
                                                                  // tablero)
    ...
    /**
     * Inicializa todos los atributos y la posición inicial de la tortuga asi como
     * el boligrafo que lleva
     * De manera predeterminada el boligrafo es true i.e se encuentra arriba es
     * decir que no escribe
     */
    public static void inicializarDatos() {
        entrada = new Scanner(System.in);
        direccion = 0;// < controla si va de izquierda-derecha, derecha-izquierda, arriba-abajo,
                      // abajo-arriba
    ...
    public static void mostrarMenu() {
        System.out.print("\n--------- MENU --------- ");
        System.out.println("\n\t1. Boligrafo no escribe (predeterminado)");
        System.out.println("\t2. Boligrafo escribe");
        System.out.println("\t3. Gira a la derecha");
        System.out.println("\t4. Gira a la izquierda");
        System.out.println("\t5. Desplazar tortuga");
        System.out.println("\t6. Mostrar el piso");
